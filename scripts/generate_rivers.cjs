#!/usr/bin/env node
// scripts/generate_rivers.cjs
// Usage:
//   node scripts/generate_rivers.cjs <rivers.geojson> [output.json] [centerLon centerLat hexSizeKm]
...
if (process.argv.length < 3) {
    console.error('Usage: node scripts/generate_rivers.cjs <rivers.geojson> [output.json] [centerLon centerLat hexSizeKm]');
    process.exit(2);
}
